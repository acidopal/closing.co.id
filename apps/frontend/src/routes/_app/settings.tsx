...
import ContactSettingsManager from "@/components/settings/ContactSettingsManager";
...
function SettingsPage() {
  ...
  const sidebarNavItems = [
    ...
    { title: "Contact Settings", icon: Users, id: "contact-settings" },
    ...
    { title: "Data Management", icon: Database, id: "data" },
      ...
      <div className="flex flex-1 flex-col overflow-auto lg:flex-row lg:space-x-12 px-4 lg:px-8 pb-8">
        ...
        <div className="flex-1 max-w-4xl">
          <div className="space-y-6">
            ...
            {activeNav === "contact-settings" && <ContactSettingsManager />}
            ...
            {activeNav === "data" && (
              <div className="space-y-6">
                ...
                <Card className="border-red-100 shadow-sm overflow-hidden">
                  <CardHeader className="bg-red-50/50 border-b border-red-100 px-6 py-4">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-between p-4 border border-red-200 rounded-lg bg-red-50/50">
                      <div>
                        ...
                        <p className="text-xs text-red-600">
                          Permanently delete all conversations and contacts
                        </p>
                      </div>
                      <Button
                        variant="outline"
                ...
                <Card className="border-gray-100 shadow-sm overflow-hidden">
                  ...
                  <CardContent className="p-6 space-y-4">
                    <div className="grid gap-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          value="app_cb437a519e1ca0c706db11e70ab470b6"
                          readOnly
