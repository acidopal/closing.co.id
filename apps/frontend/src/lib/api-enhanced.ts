...
export const getAppId = () => {
	if (typeof localStorage !== 'undefined') {
		return (
			...
			'app_cb437a519e1ca0c706db11e70ab470b6'
		)
	}
	return import.meta.env.VITE_APP_ID || 'app_cb437a519e1ca0c706db11e70ab470b6'
}
export const getAppSecret = () => {
	...
	return import.meta.env.VITE_APP_SECRET || 'scalesecret'
}

// Legacy exports for backward compatibility
export const APP_ID =
	import.meta.env.VITE_APP_ID || 'app_cb437a519e1ca0c706db11e70ab470b6'
export const APP_SECRET = import.meta.env.VITE_APP_SECRET || 'scalesecret'
